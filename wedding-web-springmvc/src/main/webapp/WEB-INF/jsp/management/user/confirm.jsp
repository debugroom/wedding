        ...
        <div class="panel">
          <div class="formPanel">
            ...
            <form:form action="${pageContext.request.contextPath}/management/user/new/${user.userId}" 
              ...
              <form:button class="alternative-button" name="type" value="save" >ユーザ作成</form:button>
              <form:button class="alternative-button" name="type" value="return">入力画面に戻る</form:button>
            </form:form>
          </div>
        </div>
      </div>
