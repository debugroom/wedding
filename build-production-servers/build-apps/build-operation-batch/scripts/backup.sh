...
java -jar -Dspring.profiles.active=production,cassandra,jpa,cluster,message-cluster /var/local/wedding/wedding-microservice/wedding-operation/wedding-batch-operation/target/wedding-batch-operation-1.0-SNAPSHOT.jar 1>> $APPLOG_FILENAME 2>> $ERRORLOG_FILENAME
