...
@Profile({"local"})
@Component("backupCassandraWorkHelper")
public class BackupCassandraWorkHelperImpl extends AbstractBackupWorkHelper{
	...
	public String createBackupDirectory() {
		String path = new StringBuilder()
				...
				.append(operationBatchProperties.getOperationBackupCassandraDirectory())
				.append(java.io.File.separator)
