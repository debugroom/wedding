...
import org.debugroom.wedding.app.web.interceptor.AbstractAuditLoggingInterceptor;
import org.debugroom.wedding.domain.service.common.DateUtil;
import org.slf4j.MDC;

@Component
public class PortalAuditLoggingInterceptor extends AbstractAuditLoggingInterceptor{
	...
	public PortalAuditLoggingInterceptor(AuditLoggingHelper auditLoggingHelper) {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, 
		...
		auditLog.setServiceName("portal");
		auditLog.setCookie("");
		auditLog.setReferer("");
