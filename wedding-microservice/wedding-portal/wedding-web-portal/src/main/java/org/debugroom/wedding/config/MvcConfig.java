...
import org.debugroom.wedding.app.web.interceptor.PortalAuditLoggingInterceptor;
...
public class MvcConfig extends WebMvcConfigurerAdapter{
	...
	@Bean
	public PortalAuditLoggingInterceptor auditLoggingInterceptor(){
		return new PortalAuditLoggingInterceptor(auditLoggingHelper);
	}
