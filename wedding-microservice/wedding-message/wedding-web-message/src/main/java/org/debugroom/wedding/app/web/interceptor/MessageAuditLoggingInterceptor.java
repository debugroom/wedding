...
@Component
public class MessageAuditLoggingInterceptor extends AbstractAuditLoggingInterceptor{
	...
	public MessageAuditLoggingInterceptor(AuditLoggingHelper auditLoggingHelper){
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, 
		...
		auditLog.setServiceName("message");
		auditLog.setCookie("");
		auditLog.setReferer("");
