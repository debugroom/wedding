...
import org.debugroom.wedding.app.web.interceptor.ManagementAuditLoggingInterceptor;
...
public class MvcConfig extends WebMvcConfigurerAdapter{
	...
	@Bean 
	public ManagementAuditLoggingInterceptor auditLoggingInterceptor(){
		return new ManagementAuditLoggingInterceptor(auditLoggingHelper);
	}
