...
@Component
public class ManagementAuditLoggingInterceptor extends AbstractAuditLoggingInterceptor{
	...
	public ManagementAuditLoggingInterceptor(AuditLoggingHelper auditLoggingHelper){
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, 
		...
		auditLog.setServiceName("management");
		auditLog.setCookie("");
		auditLog.setReferer("");
